...
class _BaseVideoPromptImproved:
    CATEGORY = "Ollama-Magic-Nodes/Video/Improved"
    FUNCTION = "generate"
                    ...
                    with open(presets_path, "r") as f:
                        ...
                        if p:
                            ...
                            return (
                                ...
                                f"Preset {p['id']} {p['category']} - CLIP fallback Offline"
                            )
        ...
        for attempt in range(3 if small_model_mode else 1):
            try:
                raw = generate(
                    ...
                    prompt=user_prompt,
                    system=system,
                    temperature=0.4 if small_model_mode else cfg.get("temperature", 0.65),
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "OllamaLTXVVideoPromptImproved": "OMG LTX-V Improved (PromptSama Authority)",
    "OllamaWanVideoPromptImproved": "OMG Wan 2.2 Improved (PromptSama Authority)",
}
