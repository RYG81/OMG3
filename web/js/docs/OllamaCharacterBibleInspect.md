# Character Bible Inspect

## Purpose

Exposes the major Bible sections as strings/JSON.

## Typical workflow

Use it to view or route identity, face, body, wardrobe, anchors, negatives, and master prompt.
